...
<!-- 新增容器 -->
<div class="container">
    <form action="../../controller/userupdate" method="post">
        <div>
            <label for="uid">用户ID:</label>
            <input type="text" id="uid" name="uid" value="${sessionScope.uid}" readonly>
        </div>
        <div>
            <label for="uname">用户名:</label>
            <input type="text" id="uname" name="uname" value="${sessionScope.uname}" readonly>
        </div>
        <div>
