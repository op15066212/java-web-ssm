...
<div class="container">
    <form action="../../controller/commentupdate" method="post">
        <div>
            ...
            <input type="text" id="cid" name="cid" value="${sessionScope.cid}" readonly>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="datetime-local" id="date" name="date" value="${sessionScope.date}">
        </div>
        <div>
            <label for="content">评价内容:</label>
            <textarea id="content" name="content" rows="2">${sessionScope.content}</textarea>
        </div>
        <div>
